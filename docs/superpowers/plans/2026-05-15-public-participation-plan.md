...
- [ ] **Step 2: Implement service and port types**
...
- [ ] **Step 1: Add public form copy tests**

Extend copy tests with send form labels and success/error copy.

- [ ] **Step 2: Render participation form**
...
- [ ] **Step 3: Verify copy and page compile**
